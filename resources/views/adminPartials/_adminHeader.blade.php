                        ...
                        <ul class="nav navbar-nav mai-top-nav">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div role="menu" class="dropdown-menu animated flipInX">
                                    ...
                                    <a href="/blogs/images" class="dropdown-item">Images</a>
                        ...
                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                            ...
                            <li class="nav-item">
                                ...
                                <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX">
                                    ...
                                    <li><a href="{{ route('users.edit',Auth::user()->id)}}"><span class="adminpro-icon adminpro-user-rounded author-log-ic"></span>My Profile</a>
                                    </li>
                                     <li>
                                        <a href="{{ route('logout') }}"

                                        onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><span class="adminpro-icon adminpro-locked author-log-ic"></span>Log Out</a>
