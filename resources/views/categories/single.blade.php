            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="hero-nav-area">
                        ...
                        <p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span><a>Category</a> <span class="lnr lnr-arrow-right"></span><a>{{$category->name}}</a></p>
                    </div>
                </div>
